...
const MainLayout: React.FC = () => {
  ...
  const noticeMenuItems: MenuProps['items'] = notices.map(notice => ({
    ...
    label: (
      <div>
        <div style={{ fontWeight: notice.read ? 'normal' : 'bold' }}>
          {notice.title}
        </div>
  ...
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      >
        <div className="logo" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', color: '#fff', fontSize: collapsed ? '1rem' : '1.2rem', fontWeight: 'bold' }}>
